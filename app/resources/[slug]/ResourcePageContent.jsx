        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="space-y-2">
              {['general-liability', 'professional-liability', 'general-liability', 'general-liability', 'umbrella-excess-liability'].map(slug => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {['armed guards', 'small-guard companys', 'large-guard companys', 'flatbed', 'refrigerated'].map(slug => (
