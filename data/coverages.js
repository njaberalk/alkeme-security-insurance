export const coverages = [
  ...
  },
  {
    ...
    relatedCoverages: ['general-liability', 'umbrella-excess', 'security-operations-liability'],
  },
  {
    slug: 'security-operations-liability',
    title: 'Security Operations Liability',
    metaTitle: 'Security Operations Liability Insurance for Guard Companies',
    metaDescription: 'Security operations liability insurance for guard companies. Covers liability from patrol failures, missed security rounds, breach response errors, and operations breakdowns.',
    heroHeading: 'Security Operations Liability Insurance',
    heroSubheading: 'Specialized coverage for liability arising from security operations failures, missed patrol rounds, breach response errors, and service breakdowns.',
    overview: 'Security operations liability insurance addresses the unique exposures that arise when your guard operations fall short. Unlike professional liability, which covers errors in judgment or advice, security operations liability specifically targets the operational failures that lead to client losses: missed patrol rounds, failure to lock or secure access points, delayed alarm response, guard no-shows, and breakdowns in shift handoff procedures that leave a site unprotected.',
    sections: [
      {
        heading: 'What It Covers',
        content: 'Security operations liability covers claims arising from failures in the execution of your guard services. This includes missed or incomplete patrol rounds where a guard skips checkpoints, failure to secure doors, gates, or access points at the end of a shift, delayed or inadequate response to on-site security breaches, and guard no-shows that leave a client site unprotected.\n\nThe coverage also addresses shift handoff failures where critical information about ongoing security situations is not communicated between guards, leading to gaps in protection. Claims from clients who suffer theft, vandalism, or unauthorized entry because your team failed to execute the contracted security protocol are the core of this coverage.',
      },
      {
        heading: 'Who Needs It',
        content: 'Any security company that places guards on post at client locations needs security operations liability coverage. The risk is especially acute for companies managing multiple sites with rotating guard schedules, overnight shifts, and remote locations where supervision is limited.\n\nCompanies providing patrol services, static guard posts, access control staffing, and gatehouse operations face the highest frequency of operations liability claims. A single missed round coinciding with a break-in can generate a claim that exceeds the value of the entire contract.',
      },
      {
        heading: 'Why It Matters',
        content: 'Client contracts increasingly include service level agreements with specific patrol frequencies, checkpoint verification requirements, and response time guarantees. When your operations fail to meet these standards and a loss occurs, the client will pursue your company for the resulting damages.\n\nOperations liability claims are among the most defensible when proper documentation exists, but among the most costly when guard tour records, checkpoint logs, and incident reports are incomplete or missing. This coverage ensures your company can defend and settle these claims without depleting operating capital.',
      },
      {
        heading: 'Key Coverage Features',
        bullets: [
          'Missed patrol round and checkpoint failure claims',
          'Guard no-show and scheduling failure liability',
          'Shift handoff communication breakdown claims',
          'Failure to secure access points, doors, gates, and loading docks',
          'Delayed breach response and alarm acknowledgment failures',
          'Client property loss resulting from operations breakdowns',
          'Defense costs for contract performance disputes',
        ],
      },
    ],
    faqs: [
      { q: 'How is security operations liability different from professional liability?', a: 'Professional liability covers errors in judgment, advice, and service design. Security operations liability covers the execution failures, such as a guard missing a patrol round or failing to lock a gate, that directly lead to client losses.' },
      { q: 'Does this cover guard no-shows?', a: 'Yes. If a guard fails to report for a shift and the unprotected site suffers a loss, security operations liability covers the resulting claim from the client.' },
      { q: 'Are electronic guard tour verification failures covered?', a: 'Yes. Claims arising from missed checkpoints, whether verified by electronic tour systems or manual logs, fall within this coverage.' },
    ],
    relatedCoverages: ['professional-liability', 'general-liability', 'umbrella-excess'],
  },
  {
    slug: 'surveillance-data-liability',
    title: 'Surveillance & Data Liability',
    metaTitle: 'Surveillance Data Liability Insurance for Security Companies',
    metaDescription: 'Surveillance data liability insurance for security companies. Covers CCTV footage exposure, access control data breaches, biometric data violations, and client information leaks.',
    heroHeading: 'Surveillance & Data Liability Insurance',
    heroSubheading: 'Protection against claims from CCTV footage exposure, access control data breaches, biometric data violations, and sensitive client information leaks.',
    ...
    sections: [
      {
        heading: 'What It Covers',
        content: 'Surveillance data liability covers claims arising from the exposure, misuse, or breach of surveillance footage, access control data, and biometric information your company collects during security operations. This includes unauthorized access to CCTV recordings, leaked footage from client sites, compromised access control credentials that allow unauthorized building entry, and violations of biometric privacy laws when your company collects fingerprints or facial recognition data.\n\nThe coverage pays for breach notification costs, forensic investigation, regulatory defense, fines under state biometric privacy statutes like BIPA, and third-party lawsuits from individuals whose images or data were exposed. It also covers claims from clients whose facility security was compromised because your data systems were breached.',
      },
      {
        heading: 'Why Security Companies Face Elevated Data Risk',
        content: 'Unlike general businesses that face standard data breach risks, security companies hold data that can directly endanger people and property. Leaked surveillance footage can be used for stalking, blackmail, or corporate espionage. Compromised access control credentials provide physical entry to secured buildings. Biometric data, once exposed, cannot be changed like a password.\n\nThe rapid adoption of cloud-connected IP cameras, mobile credential apps, and facial recognition systems has dramatically expanded the data footprint of modern security companies. Many firms now manage terabytes of video data across hundreds of client sites, all representing potential liability.',
      },
      {
        heading: 'Biometric Data Compliance',
        content: 'Illinois BIPA, Texas CUBI, and Washington state biometric laws impose strict requirements on companies that collect fingerprints, facial geometry, or iris scans. Security companies using biometric access readers or facial recognition systems must comply with notice, consent, retention, and destruction requirements.\n\nViolations carry statutory damages of $1,000 to $5,000 per incident in Illinois, and class action lawsuits under BIPA have produced settlements exceeding $200 million. Surveillance data liability insurance covers defense costs and damages from biometric privacy claims.',
      },
      {
        heading: 'Key Coverage Features',
        bullets: [
          'CCTV footage exposure and unauthorized access claims',
          'Access control credential breach liability',
          'Biometric data privacy violations under BIPA, CUBI, and similar statutes',
          'Client facility security compromise from data breaches',
          'Regulatory defense and fines from data protection authorities',
          'Forensic investigation and breach notification costs',
          'Third-party lawsuits from individuals captured on leaked surveillance',
        ],
      },
    ],
    faqs: [
      { q: 'Does this cover leaked CCTV footage from a client site?', a: 'Yes. If surveillance footage your company manages is accessed without authorization, leaked, or stolen, this coverage responds with breach costs, client notification, and defense against lawsuits from affected individuals.' },
      { q: 'Are biometric privacy lawsuits covered?', a: 'Yes. Claims under BIPA, CUBI, and similar state biometric privacy laws are covered, including statutory damages and class action defense costs.' },
      { q: 'How is this different from general cyber liability?', a: 'General cyber liability covers broad data breach risks. Surveillance data liability is specifically designed for the unique data security companies handle: video footage, access credentials, biometric scans, and facility security information.' },
    ],
    relatedCoverages: ['professional-liability', 'security-operations-liability', 'general-liability'],
  },
  {
