...
const LINK_MAP = [
  ...
  ['security operations liability', '/coverage/security-operations-liability/'],
  ['surveillance data liability', '/coverage/surveillance-data-liability/'],
  ['surveillance and data liability', '/coverage/surveillance-data-liability/'],
  ...
  ['mobile patrol', '/industries/mobile-patrol/'],
  ['loss prevention', '/industries/loss-prevention/'],
