...
const steps = [
  { num: '01', title: 'Tell Us About Your Operation', desc: 'Share details about your guard services, client types, state licensing, and current coverage so we can understand your unique needs.' },
  { num: '02', title: 'Review Your Risks & Requirements', desc: 'Our specialists analyze your exposure areas, compliance requirements, and contract obligations to identify optimal coverage strategies.' },
