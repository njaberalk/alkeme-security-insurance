    ...
    <section className="bg-blue-dark" style={{ padding: '6rem 0' }}>
      <div ref={ref} className="max-w-[900px] mx-auto px-[60px] max-lg:px-6 max-md:px-4 text-center fade-in-view">
        ...
        <blockquote className="text-stone font-light leading-relaxed mb-8" style={{ fontSize: 'clamp(1.25rem, 3vw, 1.6rem)', lineHeight: '1.6' }}>
          Working with this team made it easy to secure the right coverage for our security company. They understood our operation, moved quickly, and gave us confidence that our risks were properly covered.
        </blockquote>
        <div>
          <div className="text-stone font-bold" style={{ fontSize: '1rem' }}>David Chen</div>
          <div className="text-cream/70" style={{ fontSize: '0.85rem' }}>Operations Director, Pacific Coast Security Services</div>
        </div>
      </div>
    </section>
  );
